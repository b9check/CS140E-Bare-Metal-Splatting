...
ifndef CS140E_SPLAT_PATH
$(error CS140E_SPLAT_PATH is not set: add "export CS140E_SPLAT_PATH=/path/to/CS140E-Bare-Metal-Splatting" to ~/.bashrc)
endif
...
OD  = $(ARM)-objdump
OCP = $(ARM)-objcopy
LPP = $(CS140E_SPLAT_PATH)/libpi
LPI ?= $(LPP)/libpi.a
LGCC ?= $(CS140E_SPLAT_PATH)/lib/libgcc.a
...
CPP_ASFLAGS =  -nostdlib -nostartfiles -ffreestanding   -Wa,--warn -Wa,--fatal-warnings -Wa,-mcpu=arm1176jzf-s -Wa,-march=armv6zk -Wa,-mfpu=vfp   $(INC)
